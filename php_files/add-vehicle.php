...
if (strlen($_SESSION['vpmsaid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $categoryId = $_POST['catename']; // Use category ID
        $vehcomp = $_POST['vehcomp'];
        $vehreno = $_POST['vehreno'];
        $ownername = $_POST['ownername'];
        $ownercontno = $_POST['ownercontno'];

        // Insert data into tblvehicle
        $query = mysqli_query($con, "INSERT INTO tblvehicle(ParkingNumber, VehicleCategory, VehicleCompanyname, RegistrationNumber, OwnerName, OwnerContactNumber) 
            VALUES ('$parkingnumber', '$categoryId', '$vehcomp', '$vehreno', '$ownername', '$ownercontno')");
